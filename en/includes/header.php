		...
		<nav class="navigation" id="navigation">
            <div class="container">
                <div class="mobile-navigation">
                    <a class="logo" href="https://rottenporkofficial.com/en/">
                    ...
                    <div class="dropdown lang-dropdown d-lg-none">
                        ...
                        <div class="dropdown-menu" aria-labelledby="lang-dropdown">
                            <a class="dropdown-item" href="https://rottenporkofficial.com/en/">English</a>
                            <a class="dropdown-item" href="https://rottenporkofficial.com/">Spanish</a>
                        </div>
                    </div>
