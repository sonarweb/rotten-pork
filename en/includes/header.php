            ...
            <div class="container">
                ...
                <div class="sidebar">
                    ...
                    <ul class="nav main-navigation">
                        <li class="nav-item">
                            <a class="nav-link hover-red" href="index.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hover-red" href="bio.php">Bio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hover-red" href="discografia.php">Music</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hover-red" href="contacto.php">Contact</a>
                        </li>  
                    </ul>
